...
void LED_TaskFunc(void *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  LED_TaskHandle = osThreadNew(LED_TaskFunc, NULL, &LED_Task_attributes);
...
/* USER CODE BEGIN Header_LED_TaskFunc */
/**
* @brief Function implementing the LED_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_LED_TaskFunc */
void LED_TaskFunc(void *argument)
{
  /* USER CODE BEGIN LED_TaskFunc */
  /* Infinite loop */
  for(;;)
  {
